...
import { Minus, Plus, Trash2, ShoppingBag, ArrowRight, Utensils } from 'lucide-react';
  ...
  if (cart.length === 0) {
    return (
      ...
      >
        ...
        <p className="mb-7 text-sm" style={{ color: '#5C2A0A', fontFamily: 'var(--font-body)' }}>Add some delicious items to get started!</p>
        <Link
          to="/menu"
  ...
  return (
    <div className="min-h-screen py-8 px-4" style={{ backgroundColor: '#FFFFFF' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-6">
          <h1
            style={{ fontFamily: 'var(--font-display)', color: '#2e210e', fontWeight: 700, fontSize: '2rem' }}
          >
            Your Cart
          </h1>
        ...
        >
          <h3
            ...
            style={{ color: '#6B3F1E', fontFamily: 'var(--font-display)' }}
          >
            Order Summary
          </h3>
